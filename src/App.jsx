    ...
    <div className="app">
      ...
      {showAbout && (
        <div className="modal-overlay">
          <div className="modal about-modal">
            ...
            <div className="about-section"><h3>🔒 Privacy</h3><ul><li>✓ No personal data collected (guest mode)</li><li>✓ No tracking or cookies</li><li>✓ No ads ever</li></ul></div>
      ...
      <style jsx>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .reset-progress-btn { background: none; border: 1px solid #ccc; padding: 0.4rem 0.8rem; border-radius: 8px; cursor: pointer; color: #c0392b; border-color: #c0392b; }
